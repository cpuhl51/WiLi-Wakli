...
# --- 1. SETUP ---
st.set_page_config(page_title="Wien Öffis V39", layout="wide", page_icon="🚋")
...
# --- 2. GRAFIKEN (BASE64 - KORRIGIERT & UNTERSCHEIDBAR) ---

# Kleines H für Stationen
...
# BIM (Rot)
ICON_TRAM = "data:image/png;base64,"
...
# Strecken erweitert (inkl. City Busse & S-Bahn Stammstrecke)
RAW_ROUTES = {
...
def get_vehicle_position_and_rotation(line_name, minutes_away):
    ...
    if route_key not in SMOOTH_ROUTES:
        ...
        elif "A" in route_key and len(route_key) == 2: route_key = "1A" # Simple Fallback
...
for v in vehicles:
    ...
    if lat and lon:
        ...
        icon_b64, w, h = get_icon_props(v) # Richtiges Icon holen
